                                ...
                                <div class="order" v-for="(data,index) in dataList" :key="index" >
                                    ...
                                    <div class="flex p-30" @click="toDetail(data.reportId)">
                                        ...
                                        <div class="order-con">
                                            ...
                                            <p  :style="{color:(data.remarksState == 2 ? '#333':'#D23535')}">
                                                <span v-show="data.sysNum">System inventory:{{data.sysNum}};</span>
                                                <span v-show="data.reportNum">Report inventory:{{data.reportNum}};</span>
                                                <span v-show="data.differNum">Differential inventory:{{data.differNum}}</span>
                                            </p>
                                    ...
                                    <div class="order-footer" v-if="data.remarksState == 1">
                                        <div class="btn fl-right" @click="toError(data.reportId)" >Abnormal handling of inventory</div>
                                    </div>
                                </div>
                            </div>
                        </scroll>
