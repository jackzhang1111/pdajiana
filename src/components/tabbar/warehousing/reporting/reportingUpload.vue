<template>
  <div class="reporting-upload">
    ...
    <div v-if="positionList.length > 0">
      ...
      >
        <div class="m-b-20">
          position {{ index + 1 }}:{{ position.regionName }}
        </div>
        <div class="m-b-20">
          The current system available inventory is 0, unable to display
    ...
    <div class="good-position c-666" v-else>
      <div class="m-b-20">
    ...
    <div
      class="submit-btn"
      @click="submit"
      :style="{ background: inputDisabled ? '#000' : '#999' }"
    >
      submit
    </div>
  </div>
...
import {
  addreportModelApi,
  queryRegionNameListApi,
} from "@/api/warehousing/reporting/index.js";
